                        ...
                        <div class="banner">
                            <div class="banner-con">
                                <div class="banner-title">
                                    <span id="bus"><a class="banner-on">法人</a><i class="index-arrow-down"></i></span>
                                ...
                                <#--功能正常，目前不需要    -->
                                    <span id="ps"><a>个人</a><i class="index-arrow-down"></i></span>
                                    <span id="kc"><a>重点人群</a><i class="index-arrow-down"></i></span>
                                    <span id="code"><a>授权码查询</a><i class="index-arrow-down"></i></span>
                                </div>
                                <div class="banner-input">
                                    <span class="box-input">
                                        <input id="queryInput" type="text" onfocus="clearMsg()" placeholder="请输入企业名称，法定代表人姓名，工商注册号，组织机构代码">
                                    </span>
...
<script type="text/javascript">
    ...
    $('.banner-title span').click(function () {
        ...
        if (id == "bus") {
            ...
            $("#queryInput").attr("placeholder", "请输入姓名");
        }
        else if (id == "self") {
            ...
            $("#queryInput").attr("placeholder", "请输入授权码");
        }
//        support();
    });
...
//            console.log($(this).attr("id"));
    ...
    function searchInfo() {
        ...
        if (keyWord && keyWord.length > 1) {
            ...
            if (id == "bus") {
                $.ajax({
                    url: encodeURI("/credit/query/bs/bsSearch.do?keyword=" + keyWord),
