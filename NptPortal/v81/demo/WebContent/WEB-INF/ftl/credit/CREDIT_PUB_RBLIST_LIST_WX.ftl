...
<div class="con-bottom">
    ...
    <div class="bot_con">
        <table class="table" border="0" width="100%" cellpadding="0" cellspacing="0" style="word-break:break-all;border-collapse:collapse;">
            <thead>
...
//        $(this).addClass("on").siblings("tr").removeClass("on");
        window.location.href="http://npt.natapp1.cc/credit/pub/rbl/detailMobile.do?poolId=${RequestParameters.poolId}&primaryKeyValue="+va;
