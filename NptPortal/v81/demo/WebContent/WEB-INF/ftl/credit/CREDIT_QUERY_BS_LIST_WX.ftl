...
<div>
    <div class="con-bottom">
        <div class="table-responsive">
            <table  class="table-striped table"  width="100%" cellpadding="0" cellspacing="0" style="table-layout:fixed;word-break:break-all;border-collapse:collapse;">
                <thead>
...
//  var m = 1;
    ...
    $("table tr").bind("click",function(){
      ...
      // window.location.href="http://localhost:8080/credit/query/bs/detailMobile.do?ukValue="+va;
    })
