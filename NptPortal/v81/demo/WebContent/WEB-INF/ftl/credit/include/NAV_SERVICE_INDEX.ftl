    ...
    <div class="height_auto nav-md">
        <div class="left_nav">
            ...
            <ul id="nav">
                ...
                <li onclick="loginSrv('/credit/srv/promise/add.do',null,'#mainContent')"  data-toggle="modal" data-target="#myModal-promise"><a>信用承诺</a></li>
                <li onclick="loginSrv('/credit/srv/promise/list.do',null,'#mainContent')"><a>我的承诺</a></li>
            </ul>
        </div>
    </div>
</div>
