...
public class NptSyncAction {
    ...
    /**
     *  author: zhanglei
     *  date:   2017/05/05 11:51
     *  note:
     *          auto apply
     */
    @RequestMapping(value = "/autoUpdateApplyInfo.do")
    public void atuoUpdateApplyInfo() {
        List<ApplyInfo> list = applyInfoService.getActiveApplyInfo(String.valueOf(NptDict.RCS_NOTSYNED.getCode()));
        for (ApplyInfo applyInfo : list) {
            applyInfoService.updateAppInfo(applyInfo.getId(), String.valueOf(NptDict.USER_APPLY_SUCCESS.getCode()), String.valueOf(NptDict.RCS_SYNED.getCode()));
        }
    }
}
