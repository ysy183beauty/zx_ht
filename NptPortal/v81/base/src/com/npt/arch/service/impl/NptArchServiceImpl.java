package com.npt.arch.service.impl;
...
public class NptArchServiceImpl implements NptArchService{
    ...
    public Collection<NptLogicDataField> listDataField(Long typeId, NptDict pubLevel, NptDict status) {
        Collection<NptLogicDataField> result = new ArrayList<NptLogicDataField>();
        NptLogicDataTable type = tableManager.findById(typeId);
        if(null != type){
     ...
     */
    @Override
    public NptLogicDataProvider findParent(NptLogicDataTable type) {
        if(null != type){
            NptLogicDataTable _this = tableManager.findById(type.getId());
            if(null != _this){
     ...
     */
    @Override
    public NptLogicDataTable findParent(NptLogicDataField field) {
        return null;
    }
     ...
     */
    @Override
    public NptLogicDataTable findDataTableById(Long id) {
        return tableManager.findById(id);
    }

    @Override
    public NptLogicDataTable fastFindDataTableById(Long id) {
     ...
     */
    @Override
    public void save(NptLogicDataTable type) {
     ...
     */
    @Override
    public void update(NptLogicDataTable type) {
     ...
     */
    @Override
    public void delete(NptLogicDataTable type) {
     ...
     */
    @Override
    public void batchSaveDataTable(Collection<NptLogicDataTable> list) {
     ...
     */
    @Override
    public void batchUpdateDataTable(Collection<NptLogicDataTable> list) {
        if(null != list && !list.isEmpty()){
