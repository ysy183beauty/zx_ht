package com.npt.arch.entity;


import com.npt.base.NptAuthorityEntity;
...
public class NptLogicDataTable extends NptAuthorityEntity {
    ...
    public void copyTo(NptBaseEntity entity) {
        Assert.isTrue(entity instanceof NptLogicDataTable);
        super.copyTo(entity);
        NptLogicDataTable that = (NptLogicDataTable) entity;
