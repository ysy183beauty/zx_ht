...
<#--<div >-->
    <#--<header style='width:100%;height:30px;background-color:#46a3ff;positiqon:fixed;top:0px;left:0px;margin:0px;text-align:center;'><font color="white" style="font-family:楷体">当前位置:首页-重点人群查询</font></header>-->
<#--</div>-->
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" style="table-layout:fixed;word-break:break-all;border-collapse:collapse;">
            ...
            <#if data.dataList??>
                ...
                <tr>
                    ...
                    <#--<td><a href="/credit/query/kc/detailMobile.do?poolId=${RequestParameters.poolId}&primaryKeyValue=${list.dataArray[0].value}" target="_blank">详细数据</a></td>-->
...
//        $(this).addClass("on").siblings("tr").removeClass("on");
    window.location.href="http://npt.s1.natapp.cc/credit/query/kc/detailMobile.do?poolId=${RequestParameters.poolId}&primaryKeyValue="+va;
})
    $(function () {
        //生成分页控件
    ...
    function search(n) {
        $.ajax({
            url: "/credit/query/kc/listMobile.do",
            data: {
