    ...
    <#else>
        <#if data.dataList??>
            <#list data.dataList as dataList>
                <div class="col-sm-6">
                        <div>
                            <b class="col-sm-4">${dataList.dataArray[1].title}:${dataList.dataArray[1].value}</b>
                            <span class="box-address col-sm-8">${dataList.dataArray[2].title}:${dataList.dataArray[2].value}</span>
                        </div>
