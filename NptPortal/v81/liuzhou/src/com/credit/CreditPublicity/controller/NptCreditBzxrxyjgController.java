...
import com.npt.querier.impl.NptCreditBzxrxyjgQuerierBase;
 ...
 */
@Controller
@RequestMapping(value = "/pub/bzxrxyjg")
public class NptCreditBzxrxyjgController {

    @Autowired
    private NptCreditBzxrxyjgQuerierBase querier;
    ...
    public String list(NptWebBridgeBean bean, int flag, HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
        ...
        NptDict gCode;
        if (flag == NptDict.BMHG_BZXRXYJG_BZXR.getCode()) {
            gCode = NptDict.BMHG_BZXRXYJG_BZXR;
        } else {
            gCode = NptDict.BMHG_BZXRXYJG_SXBZXR;
        }
