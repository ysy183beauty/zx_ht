...
public abstract class NptAbstractCommonQuerier implements NptCommonQuerier {
    ...
    @Override
    public NptDict loadBaseModelOpenList(NptWebBridgeBean bean, NptBaseModel m, Boolean applyed) {
        return service.loadBaseModelOpenList(bean, m, applyed);
    }
    ...
    public NptWebBridgeBean constructOpenWebBridgeBean(NptBaseModel m) {
        ...
        service.loadBaseModelConditions(m,bean);

        NptBaseModelTree tree = service.loadBaseModelTree(m);
    ...
    public NptBaseModelPool getBaseModelGroupMainPool(NptBaseModel m) {
        return service.getBaseModelGroupMainPool(m);
    }
}