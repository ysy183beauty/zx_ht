        ...
        <div class="span12">
            <div class="portlet box boxTheme">
                ...
                <div class="portlet-body form">
                    <form action="listPRDByCondition.action" onsubmit="return approvalFilter(this)" class="form-horizontal">
                        <div class="row-fluid">
                            <div class="span4">
...
<script>
    ...
    function showApproval(applyNo) {
        $.post("showPRDApproval.action", {primaryKeyValue: applyNo}, function (data) {
    ...
    * */
    function approval(form) {
        $.post("approvalByPRD.action", $(form).serialize(), function (data) {
            if (data.result) {
