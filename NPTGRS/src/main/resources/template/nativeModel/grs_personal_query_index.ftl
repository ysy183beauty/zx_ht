...
<div id="indexDiv">
    <div class="portlet box boxTheme">
        <div class="portlet-title">
            <div class="caption"><i class="icon-search"></i>个人信用信息查询</div>
            <div class="tools">
                <#--<div class="btn-group ">-->
...
<script type="text/javascript" src="${wctx}/pub/baseModel/grs_basemodel_personal_query_controller.js"></script>
</body>
<!-- END BODY -->
