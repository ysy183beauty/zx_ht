...
<div id="indexDiv">
    <div class="portlet box boxTheme">
        <div class="portlet-title">
            <div class="caption"><i class="icon-search"></i>个人信用报告查询</div>
            <div class="tools">
...
<script type="text/javascript" src="${wctx}/pub/baseModel/grs_basemodel_personalReport_query_controller.js"></script>
</body>
<!-- END BODY -->
