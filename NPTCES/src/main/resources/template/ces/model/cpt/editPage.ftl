...
<form id="form_props" action="editCpt.${urlExt}" method="post" onsubmit="return editProps(this, refreshCptList)" class="form-horizontal no-bottom-space" >
    <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button"></button>
        <h3><i class="icon-exclamation-sign"></i> 编辑计算方法</h3>
    </div>
    <div class="modal-body">
        ...
        <input type="hidden" name="countType.id" value="${(countType.id)!}">
