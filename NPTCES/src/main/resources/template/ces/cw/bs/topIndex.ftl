        ...
        <div class="span12">
            <div class="portlet box boxTheme">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-search"></i>企业风险信息</div>
                </div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span4">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="dmsId" class="small" onchange="list()">
                            ...
                            <input type="hidden" value="15" id="ceTypeCode">
                        </div>
...
<script>
    ...
    function list() {
        ...
        $.nptPOST("topList.action", data, function (data) {
            $("#pageData tbody").html(data);
            bgColor();
        });
        pagination.initPagination("topList.${urlExt}", data,bgColor);
    }
</script>
<#--划分颜色-->
