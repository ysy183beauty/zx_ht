...
<TableDataMap>
<TableData name="c1" class="com.fr.data.impl.DBTableData">
<Parameters/>
...
<Query>
<![CDATA[select * from (select wbj "委办局名称",sjl "数据量" from nce_temp_rkltj  order by sjl desc) t where rownum<=10]]></Query>
</TableData>
<TableData name="c2" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="wbjmc"/>
<O>
<![CDATA[公安局]]></O>
</Parameter>
<Parameter>
...
<Query>
<![CDATA[select "月份","数据量" from "按月统计" where "委办局" = '${wbjmc}' and "种类" = '${type}']]></Query>
</TableData>
<TableData name="c3" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="type"/>
<O>
...
<Query>
<![CDATA[select "月份","正确率" from "按月统计" where "委办局"='${wbjmc}' and "种类"='${type}']]></Query>
</TableData>
<TableData name="c4" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<Query>
<![CDATA[select sjl 占比,wbj 委办局 from nce_temp_rkltj t]]></Query>
</TableData>
</TableDataMap>
<Parameters/>
...
<O>
<![CDATA[=\"   委办局数据比重\"]]></O>
<FRFont name="Al Bayan" style="0" size="80" foreground="-12303292"/>
<Position pos="2"/>
...
<newHotTooltipStyle>
<AttrContents>
<Attr showLine="false" position="1" isWhiteBackground="true" isShowMutiSeries="false" seriesLabel="${SERIES}${BR}${CATEGORY}${BR}${PERCENT}"/>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="委办局" valueName="占比" function="com.fr.data.util.function.NoneFunction">
...
<BoundsAttr x="496" y="36" width="498" height="535"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="0" y="0" width="498" height="36"/>
</Widget>
...
<BoundsAttr x="497" y="23" width="500" height="571"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<CategoryName value="委办局名称"/>
<ChartSummaryColumn name="数据量" function="com.fr.data.util.function.SumFunction" customName="数据量"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="false" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="y"/>
<from>
<![CDATA[]]></from>
<to>
<![CDATA[]]></to>
...
<BoundsAttr x="0" y="36" width="496" height="535"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="0" width="496" height="36"/>
</Widget>
<title class="com.fr.form.ui.Label">
<WidgetName name="title"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="23" width="497" height="571"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<CustomDictAttr>
<Dict key="入库情况" value="入库情况"/>
<Dict key="使用情况" value="使用情况"/>
</CustomDictAttr>
</Dictionary>
<widgetValue>
<O>
...
<BoundsAttr x="833" y="0" width="164" height="23"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="0" width="833" height="23"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
