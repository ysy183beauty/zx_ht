var FormComponents = function () {
    ...
    var handleDateRangePickers = function () {
        ...
        // $("input[name='startDate']").val( Date.today().toString('yyyyMMdd'));
        // $("input[name='endDate']").val( Date.today().add({days: +30}).toString('yyyyMMdd'));
        ...
        $('#form-date-range-modal').daterangepicker({
            ...
            $('#form-date-range-modal span').html(start.toString('yyyy-MM-dd') + ' 到 ' + end.toString('yyyy-MM-dd'));
        });
        $('#form-date-range-modal span').html(Date.today().add({
                days: -29
            }).toString('yyyy-MM-dd') + ' 到 ' + Date.today().toString('yyyy-MM-dd'));
    }
